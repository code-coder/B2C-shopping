...
var treeMenu = [
	{ level:1, name:"用户管理"},
	{ level:2, name:"用户列表", ico:"../../images/icon_default.gif",link:"../customer/customer_list.action"},
	{ level:1, name:"商品管理"},
	{ level:2, name:"商品类列表",ico:"../../images/icon_default.gif",link:"../product/category_list.action"},
	{ level:2, name:"添加商品类",ico:"../../images/icon_default.gif",link:"../product/category_add.action"},
	{ level:2, name:"商品列表", ico:"../../images/icon_default.gif",link:"../product/product_list.action"},
	{ level:2, name:"添加商品", ico:"../../images/icon_default.gif",link:"../product/product_add.action"},
	{ level:1, name:"订单管理"},
	{ level:2, name:"订单列表", ico:"../../images/icon_default.gif",link:"../order/order_list.action"},
	{ level:1, name:"评价管理"},
	{ level:2, name:"未回复评价", ico:"../../images/icon_default.gif",link:"../consultation/consultation_unansweredConsultation.action"},
	{ level:2, name:"已回复评价", ico:"../../images/icon_default.gif",link:"../consultation/consultation_answeredConsultation.action"},
];
</script>
<style>
* {
