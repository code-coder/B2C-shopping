	...
	$("ul.megamenu > li.hover").click(function () {
		...
		if(transition == 'slide') {
			...
			var li_height=$(this).height();
				...
				var content_height = $(this).find(".content").height()+40;
				console.log(window_height+"======="+li_top+"++++"+content_height)
				if( window_height< (li_top+content_height)){
					$(this).find(".content").css("margin-top",-content_height+li_height);
				}
		}		
		$(this).children(".sub-menu").css("right", "auto");
			if ($("html").css("direction").toLowerCase() == "rtl"){
