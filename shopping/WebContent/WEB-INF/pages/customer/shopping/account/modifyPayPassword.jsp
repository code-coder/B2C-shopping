...
<!-- start main -->
         ...
         <div>&nbsp;&nbsp;个人管理&nbsp;&nbsp;/&nbsp;&nbsp;<label>修改支付密码</label></div>
             <hr>
             <s:form cssClass="form-horizontal " action="customer_shopping_savePayPassword" method="post">
           <div class="form-group">
             <label for="inputPassword1" class="col-sm-3 control-label">原密码</label>
             <div class="col-sm-7">
               <input type="password" name="account.password" class="form-control" id="inputPassword3" placeholder="请输入原密码">
             </div>
           </div>
            <div class="form-group">
             <label for="inputPassword1" class="col-sm-3 control-label">新密码</label>
             <div class="col-sm-7">
               <input type="password" name="password.newpassword" class="form-control" id="inputPassword3" placeholder="请设置新密码">
             </div>
           </div>
           <div class="form-group">
            <label for="inputPassword3"  class="col-sm-3 control-label">确认密码</label>
            <div class="col-sm-7">
				<input type="password" name="password.repassword" class="form-control" id="inputPassword3" placeholder="再次确认密码">
			</div>
           </div>
           <div class="form-group">
